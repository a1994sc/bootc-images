...
func Process(ctx context.Context, path string, repo *string, version *string, platOS *string, platArch *string, tarBall *string, maxLayers *int) (err error) {
	...
	iv.Annotations[ocispec.AnnotationDescription] = description
	iv.Annotations[ocispec.AnnotationSource] = source
	iv.Annotations[ocispec.AnnotationLicenses] = license

	if maxLayers != nil {
		iv.MaxLayers = *maxLayers
	}
